...
Two players take turns dropping tiles into one of the seven columns, trying to make Four-in-a-Row horizontally, vertically, or diagonally.
""")
...
def getPlayerMove(playerTile, board):
    ...
    while True:  # Keep asking player until they enter a valid move.
        ...
        if response not in COLUMN_LABELS:
            ...
            continue  # Ask player agin for their move
