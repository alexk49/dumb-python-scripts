""" THE TOWER OF HANOI, by Al Sweigart. A Stack moving puzzle game.
...
"""
    ...
    while True: # Run aa single turn on each iteration of this loop
        ...
        # Move the top disk fromTower to toTower:
...
def getPlayerMove(towers):
    ...
    while True: # Keep asking player until they enter a valid move
        ...
        if len(towers[fromTower]) == 0:
            ...
            # Any disk can be moved onto an empty tower:
