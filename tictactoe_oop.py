...
# this is set to inherit the TTTBoard class
...
class HybridBoard(HintBoard, Miniboard):
    """this inherits from BOTH hint and mini board. 
    As both parent classes have a method named getBoardStr(), the hybridboard.getBoardStr will display the miniature board but also provide hints.

    This is only because the two methods can work together.

    If you switched the order of the class to HybridBoard(MiniBoard, HintBoard) then you would lose hints altogether.
    """
    pass
